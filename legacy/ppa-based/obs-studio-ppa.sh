...
export QT_PLUGIN_PATH=$HERE/lib/:$HERE/usr/lib/:$HERE/usr/lib/x86_64-linux-gnu/qt5/plugins/:$HERE/usr/lib/x86_64-linux-gnu/obs-plugins/:$HERE/usr/lib/x86_64-linux-gnu/qt5/plugins/platforms/:$QT_PLUGIN_PATH


export OBS_DATA_PATH=$HERE/usr/share/obs/obs-studio/
export OBS_PLUGINS_LIB_PATH=$HERE/usr/lib/x86_64-linux-gnu/obs-plugins/
export OBS_PLUGINS_DATA_PATH=$HERE/usr/share/obs/obs-plugins/
export LIBOBS_DATA_PATH=$HERE/usr/share/obs/libobs/
export QT_QPA_PLATFORM_PLUGIN_PATH=$HERE/usr/lib/x86_64-linux-gnu/qt5/plugins/platforms/
export OBS_INCLUDE_PATH=$HERE/usr/include/obs/

export INCLUDE_PATH=$HERE/usr/include/
